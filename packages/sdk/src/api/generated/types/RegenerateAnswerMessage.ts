...
export type AnswerMessageStatusEnum3 =
  (typeof answerMessageStatusEnum3)[keyof typeof answerMessageStatusEnum3]

export const answerMessageRoleEnum3 = {
  system: 'system',
  user: 'user',
  assistant: 'assistant',
} as const

export type AnswerMessageRoleEnum3 =
  (typeof answerMessageRoleEnum3)[keyof typeof answerMessageRoleEnum3]
...
export type RegenerateAnswerMessage200 = {
  ...
  answerMessage: {
     ...
     * @type string
     */
    status: AnswerMessageStatusEnum3
    /**
     * @type string
     */
    role: AnswerMessageRoleEnum3
    /**
     * @type array
     */
    parts:
